...
flags = tf.app.flags
FLAGS = flags.FLAGS
flags.DEFINE_string('dataset', 'mydata', 'Dataset string.')  # 'cora', 'citeseer', 'pubmed', 'mydata', "45x220"
...
flags.DEFINE_float('dropout', 0.01, 'Dropout rate (1 - keep probability).')  # 0.5
flags.DEFINE_float('weight_decay', 5e-4, 'Weight for L2 loss on embedding matrix.')
flags.DEFINE_integer('early_stopping', 20, 'Tolerance for early stopping (# of epochs).')
flags.DEFINE_integer('max_degree', 3, 'Maximum Chebyshev polynomial degree.')

# Load data
adj, features, y_train, y_val, y_test, train_mask, val_mask, test_mask = utils.load_data(FLAGS.dataset)
